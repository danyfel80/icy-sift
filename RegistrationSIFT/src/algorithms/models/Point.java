...
public class Point implements Serializable {
	 ...
	 * @param w
	 *          reference to the world coordinates of the {@link Point}
	 */
	 ...
	 */
	/*
	 * final public void apply( final CoordinateTransform t ) { System.arraycopy(
	 * l, 0, w, 0, l.length ); t.applyInPlace( w ); }
	 */
	 ...
	 * { final double[] a = t.apply( l ); for ( int i = 0; i < a.length; ++i ) w[
	 * i ] += amount * ( a[ i ] - w[ i ] ); }
	 */
	 ...
	 */
	/*
	 * final public void applyInverse( final InverseCoordinateTransform t ) throws
	 * NoninvertibleModelException { System.arraycopy( l, 0, w, 0, l.length );
	...
	/**
	 * Estimate the square Euclidean distance of two {@link Point Points} in world
	 * space.
	 *
	 * @param p1
	 * @param p2
	...
	/**
	 * Estimate the Euclidean distance of two {@link Point Points} in world space.
	 *
	 * @param p1
	 * @param p2
	...
	/**
	 * Estimate the square Euclidean distance of two {@link Point Points} in local
	 * space.
	 *
	 * @param p1
	 * @param p2
	...
	/**
	 * Estimate the Euclidean distance of two {@link Point Points} in local space.
	 *
	 * @param p1
	 * @param p2
	 * @return Euclidean distance
	 ...
	 * {@link Point Points}.
	 *
	 * For each {@link Point}, transfers the {@link #l local coordinates} to new
	 * {@link #w world coordinates}.
	 *
	 * @param t
	 */
	/*
	 * static public < P extends Point >void apply( final CoordinateTransform t,
	 * final Iterable< P > points ) { for ( final P p : points ) p.apply( t ); }
	 */
	/**
	 * Apply an {@link InverseCoordinateTransform} to an {@link Iterable}
	 * collection of {@link Point Points}.
	 *
	 * For each {@link Point}, transfers the {@link #l local coordinates} to new
	 * {@link #w world coordinates}.
	 *
	 ...
	 */
	/*
	 * static public void applyInverse( final InverseCoordinateTransform t, final
	 * Iterable< Point > points ) throws NoninvertibleModelException { for ( final
	 * Point p : points ) p.applyInverse( t ); }
	 */
}
