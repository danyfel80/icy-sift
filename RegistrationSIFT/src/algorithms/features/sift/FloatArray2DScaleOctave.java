...
public class FloatArray2DScaleOctave {
	 ...
	 * 
	 * the first member is the sigma of the gaussian kernel that is assumed to be
	 * the generating kernel of the first gaussian image instance of the octave
	 */
	public float[] SIGMA;
	 ...
	 * 
	 * @param img
	 *          image being the first gaussian instance of the scale octave img
	 ...
	 * 
	 * Use this method for the partial creation of an octaved scale space without
	 * creating each scale octave. Like proposed by Lowe \citep{Lowe04}, you can
	 * use this image to build the next scale octave. Taking every second pixel of
	 * this image, you get a gaussian image with INITIAL_SIGMA of the half image
	 * size.
	 */
	 ...
	 * 
	 * For efficiency reasons, the dimensions of {@link dst} are not checked, that
	 * is, you have to take care, that dst.width == src.width / 2 + src.width % 2
	 ...
	 * 
	 * For efficiency reasons, the dimensions of {@link dst} are not checked, that
	 * is, you have to take care, that src.width == dst.width / 2 + dst.width % 2
